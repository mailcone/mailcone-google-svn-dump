...
rpm_spec_css = Resource(library, 'mode/spec/spec.css', depends=[codemirror_js])
rpm_spec = Resource(library, 'mode/spec/spec.js', depends=[codemirror_js, rpm_spec_css])
...
util_simple_hint = Resource(library, 'lib/util/simple-hint.js', depends=[codemirror_js, util_simple_hint])
